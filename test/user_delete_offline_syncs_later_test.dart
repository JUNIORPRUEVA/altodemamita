...
void main() {
  ...
  setUp(() async {
    ...
    tempDirectory = await Directory.systemTemp.createTemp('user_delete_offline_sync_');
  ...
  test('user delete while offline remains pending delete and can be synced later', () async {
