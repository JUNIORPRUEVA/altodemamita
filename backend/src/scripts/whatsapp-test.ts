...
const ELEGANT3_PROJECT_TEST_PARAMETERS = [
  'MM-H-S88',
  'Mayo 2026',
  'RD$8,415.14',
  'RD$2,524.54',
...
const ELEGANT5_PROJECT_TEST_PARAMETERS = [
  'MM-H-S88',
  'Marzo 2026',
  'RD$8,415.14',
  'RD$2,524.54',
...
const ELEGANT4_PROJECT_TEST_PARAMETERS = [
  'MM-H-S88',
  'Abril 2026',
  'RD$8,415.14',
  'RD$2,524.54',
...
const ELEGANT2_PROJECT_TEST_PARAMETERS = [
  'MM-H-S88',
  'Junio 2026',
  'RD$8,415.14',
  'RD$2,524.54',
...
const ELEGANT1_PROJECT_TEST_PARAMETERS = [
  'MM-H-S88',
  'Julio 2026',
  'RD$8,415.14',
  'RD$84.15',
...
async function main() {
  ...
  const parameters = testParametersForTemplate(config.whatsappPaymentTestTemplate);
...
function testParametersForTemplate(templateName: string) {
  const parametersByTemplate: Record<string, string[]> = {
    [PROFESSIONAL5_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT5_PROJECT_TEST_PARAMETERS,
    [PROFESSIONAL4_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT4_PROJECT_TEST_PARAMETERS,
    [PROFESSIONAL3_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT3_PROJECT_TEST_PARAMETERS,
    [PROFESSIONAL2_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT2_PROJECT_TEST_PARAMETERS,
    [PROFESSIONAL1_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT1_PROJECT_TEST_PARAMETERS,
    [ELEGANT5_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT5_PROJECT_TEST_PARAMETERS,
    [ELEGANT4_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT4_PROJECT_TEST_PARAMETERS,
    [ELEGANT3_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT3_PROJECT_TEST_PARAMETERS,
    [ELEGANT2_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT2_PROJECT_TEST_PARAMETERS,
    [ELEGANT1_PROJECT_PAYMENT_REMINDER_TEMPLATE]: ELEGANT1_PROJECT_TEST_PARAMETERS,
    [DETAILED5_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED5_PROJECT_TEST_PARAMETERS,
    [DETAILED4_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED4_PROJECT_TEST_PARAMETERS,
    [DETAILED3_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED3_PROJECT_TEST_PARAMETERS,
    [DETAILED2_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED2_PROJECT_TEST_PARAMETERS,
    [DETAILED1_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED1_PROJECT_TEST_PARAMETERS,
    [DETAILED_PROJECT_PAYMENT_REMINDER_TEMPLATE]: DETAILED_PROJECT_TEST_PARAMETERS,
    [PROJECT_PAYMENT_REMINDER_TEMPLATE]: PROJECT_TEST_PARAMETERS,
  };
  return parametersByTemplate[templateName] ?? LEGACY_TEST_PARAMETERS;
}
