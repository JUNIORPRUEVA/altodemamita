...
void main() {
  ...
  test('products_download_does_not_revive_local_pending_delete_test', () async {
    ...
    await db.insert(DatabaseSchema.lotsTable, {
      ...
      'deleted_at': '2026-05-05T12:00:00.000Z',
    ...
    expect(row['deleted_at'], '2026-05-05T12:00:00.000Z');
    expect(row['sync_status'], DatabaseSchema.syncStatusPendingDelete);
    expect(row['estado'], 'disponible');
  });
}
